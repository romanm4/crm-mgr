...
public class LeadSpecification implements Specification<LeadEntity> {
    private List<SearchCriteria> searchCriteria;

    public LeadSpecification() {
    ...
    @Override
    public Predicate toPredicate(Root<LeadEntity> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
